...
namespace air_reservation.Migrations
{
    ...
    [Migration("20250605081915_InitAirline")]
            ...
            modelBuilder.Entity("air_reservation.Models.Flight_Model_.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 12, 14, 19, 14, 666, DateTimeKind.Utc).AddTicks(6500),
                            AvailableBusinessSeats = 30,
                            AvailableEconomySeats = 150,
                            BusinessPrice = 899.99m,
                            DepartureDateTime = new DateTime(2025, 6, 12, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(6492),
                        ...
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 10, 11, 19, 14, 666, DateTimeKind.Utc).AddTicks(6508),
                            AvailableBusinessSeats = 24,
                            AvailableEconomySeats = 120,
                            BusinessPrice = 699.99m,
                            DepartureDateTime = new DateTime(2025, 6, 10, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(6507),
                            Destination = "Miami",
                        ...
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 9, 10, 19, 14, 666, DateTimeKind.Utc).AddTicks(6512),
                            AvailableBusinessSeats = 28,
                            AvailableEconomySeats = 140,
                            BusinessPrice = 599.99m,
                            DepartureDateTime = new DateTime(2025, 6, 9, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(6512),
                            Destination = "Seattle",
                        ...
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 11, 9, 19, 14, 666, DateTimeKind.Utc).AddTicks(6516),
                            AvailableBusinessSeats = 40,
                            AvailableEconomySeats = 180,
                            BusinessPrice = 499.99m,
                            DepartureDateTime = new DateTime(2025, 6, 11, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(6516),
                            Destination = "Paris",
                        ...
                        new
                        {
                            ...
                            Aircraft = "Boeing 737",
                            Airline = "Air France",
                            ArrivalDateTime = new DateTime(2025, 6, 13, 10, 19, 14, 666, DateTimeKind.Utc).AddTicks(6535),
                            AvailableBusinessSeats = 35,
                            AvailableEconomySeats = 160,
                            BusinessPrice = 579.99m,
                            DepartureDateTime = new DateTime(2025, 6, 13, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(6520),
                            Destination = "Berlin",
                        ...
                        new
                        {
                            ...
                            Aircraft = "Airbus A320",
                            Airline = "Qantas",
                            ArrivalDateTime = new DateTime(2025, 6, 8, 9, 19, 14, 666, DateTimeKind.Utc).AddTicks(6540),
                            AvailableBusinessSeats = 42,
                            AvailableEconomySeats = 190,
                            BusinessPrice = 459.99m,
                            DepartureDateTime = new DateTime(2025, 6, 8, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(6540),
                        ...
                        new
                        {
                            ...
                            Aircraft = "Boeing 777",
                            Airline = "Emirates",
                            ArrivalDateTime = new DateTime(2025, 6, 15, 15, 19, 14, 666, DateTimeKind.Utc).AddTicks(6544),
                            AvailableBusinessSeats = 50,
                            AvailableEconomySeats = 200,
                            BusinessPrice = 999.99m,
                            DepartureDateTime = new DateTime(2025, 6, 15, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(6543),
            ...
            modelBuilder.Entity("air_reservation.Models.Users_Model_.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 6, 5, 8, 19, 14, 666, DateTimeKind.Utc).AddTicks(5839),
                            Email = "aster@gmail.com",
                            FirstName = "Aster",
                            LastName = "Admin",
                            Password = "$2a$11$kIHav10C9CCMPMd4456np.GT9fYrxUBEGHJF8X8eaRWme92jCPhDm",
