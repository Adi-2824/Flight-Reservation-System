...
namespace air_reservation.Migrations
{
    ...
    [Migration("20250613122348_airline007")]
            ...
            modelBuilder.Entity("air_reservation.Models.Flight_Model_.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 20, 18, 23, 47, 469, DateTimeKind.Utc).AddTicks(4405),
                            AvailableBusinessSeats = 30,
                            AvailableEconomySeats = 150,
                            BusinessPrice = 899.99m,
                            DepartureDateTime = new DateTime(2025, 6, 20, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(4389),
                        ...
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 18, 15, 23, 47, 469, DateTimeKind.Utc).AddTicks(4432),
                            AvailableBusinessSeats = 24,
                            AvailableEconomySeats = 120,
                            BusinessPrice = 699.99m,
                            DepartureDateTime = new DateTime(2025, 6, 18, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(4430),
                            Destination = "Miami",
                        ...
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 17, 14, 23, 47, 469, DateTimeKind.Utc).AddTicks(4446),
                            AvailableBusinessSeats = 28,
                            AvailableEconomySeats = 140,
                            BusinessPrice = 599.99m,
                            DepartureDateTime = new DateTime(2025, 6, 17, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(4443),
                            Destination = "Seattle",
                        ...
                        new
                        {
                            ...
                            ArrivalDateTime = new DateTime(2025, 6, 19, 13, 23, 47, 469, DateTimeKind.Utc).AddTicks(4458),
                            AvailableBusinessSeats = 40,
                            AvailableEconomySeats = 180,
                            BusinessPrice = 499.99m,
                            DepartureDateTime = new DateTime(2025, 6, 19, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(4455),
                            Destination = "Paris",
                        ...
                        new
                        {
                            ...
                            Aircraft = "Boeing 737",
                            Airline = "Air France",
                            ArrivalDateTime = new DateTime(2025, 6, 21, 14, 23, 47, 469, DateTimeKind.Utc).AddTicks(4510),
                            AvailableBusinessSeats = 35,
                            AvailableEconomySeats = 160,
                            BusinessPrice = 579.99m,
                            DepartureDateTime = new DateTime(2025, 6, 21, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(4474),
                            Destination = "Berlin",
                        ...
                        new
                        {
                            ...
                            Aircraft = "Airbus A320",
                            Airline = "Qantas",
                            ArrivalDateTime = new DateTime(2025, 6, 16, 13, 23, 47, 469, DateTimeKind.Utc).AddTicks(4523),
                            AvailableBusinessSeats = 42,
                            AvailableEconomySeats = 190,
                            BusinessPrice = 459.99m,
                            DepartureDateTime = new DateTime(2025, 6, 16, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(4520),
                        ...
                        new
                        {
                            ...
                            Aircraft = "Boeing 777",
                            Airline = "Emirates",
                            ArrivalDateTime = new DateTime(2025, 6, 23, 19, 23, 47, 469, DateTimeKind.Utc).AddTicks(4542),
                            AvailableBusinessSeats = 50,
                            AvailableEconomySeats = 200,
                            BusinessPrice = 999.99m,
                            DepartureDateTime = new DateTime(2025, 6, 23, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(4534),
            ...
            modelBuilder.Entity("air_reservation.Models.Users_Model_.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 6, 13, 12, 23, 47, 469, DateTimeKind.Utc).AddTicks(2128),
                            Email = "aster@gmail.com",
                            FirstName = "Aster",
                            LastName = "Admin",
                            Password = "$2a$11$Y.hvhFgGtMXKGoH2KkvyJuxuAAwkXAx15sgv0Of6W.ftV/GsC9HT.",
